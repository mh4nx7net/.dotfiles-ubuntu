        ...
        provideDocumentSymbols(document, token) {
            ...
            for (let line of lines) {
                ...
                if (root_keywords.indexOf(words[0]) !== -1) {
                    ...
                    res.push(new vscode.DocumentSymbol(name, line, kind, new vscode.Range(linum, 0, linum + funclen, lines[linum + funclen].length), new vscode.Range(linum, 0, linum, line.length)));
                }
                linum++;
            }
            return res;
