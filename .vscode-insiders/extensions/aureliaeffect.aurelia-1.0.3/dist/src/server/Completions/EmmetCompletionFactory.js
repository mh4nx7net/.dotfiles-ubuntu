...
let EmmetCompletionFactory = class EmmetCompletionFactory extends BaseAttributeCompletionFactory_1.default {
    ...
    create(elementName) {
        ...
        if (element.hasGlobalAttributes) {
            this.addAttributes(_elementStructure_1.GlobalAttributes.attributes, result, [], this.settings.quote);
        }
        if (element.attributes) {
            this.addAttributes(element.attributes, result, [], this.settings.quote);
        }
        if (element.hasGlobalEvents) {
            this.addEvents(_elementStructure_1.GlobalAttributes.events, result, [], this.settings.quote);
        }
        if (element.events) {
...
EmmetCompletionFactory = __decorate([
    aurelia_dependency_injection_1.autoinject(),
    __metadata("design:paramtypes", [_elementLibrary_1.default, AureliaSettings_1.default])
], EmmetCompletionFactory);
exports.default = EmmetCompletionFactory;
//# sourceMappingURL=EmmetCompletionFactory.js.map