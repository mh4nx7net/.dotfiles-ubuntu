...
class HrElement extends _elementStructure_1.MozDocElement {
    constructor() {
        super();
        this.documentation = `The HTML <hr> element represents a thematic break between paragraph-level
...
exports.default = HrElement;
//# sourceMappingURL=hrElement.js.map