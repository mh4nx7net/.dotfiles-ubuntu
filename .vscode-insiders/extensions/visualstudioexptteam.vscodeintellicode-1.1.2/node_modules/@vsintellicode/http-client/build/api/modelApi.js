...
class ModelApi {
    ...
    apiV1ModelByModelIdCodebasePost(modelId, modelCodebaseCreateRequest) {
        ...
        let localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(modelCodebaseCreateRequest, "ModelCodebaseCreateRequest")
        };
    ...
    apiV1ModelByModelIdDelete(modelId) {
    ...
    apiV1ModelByModelIdGet(modelId) {
        const localVarPath = this.basePath + '/api/v1/model/{modelId}'
            .replace('{' + 'modelId' + '}', encodeURIComponent(String(modelId)));
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
    ...
    apiV1ModelByModelIdInputByInputIdActionNotifyDatauploadcompletePut(modelId, inputId) {
    ...
    apiV1ModelByModelIdInputByInputIdGet(modelId, inputId) {
    ...
    apiV1ModelByModelIdInputPost(modelId, modelInputCreateRequest) {
        ...
        let localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(modelInputCreateRequest, "ModelInputCreateRequest")
        };
        this.authentications.Bearer.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
    ...
    apiV1ModelByModelIdOutputByOutputIdActionNotifyDatauploadcompletePut(modelId, outputId, modelOutputTrainingDetails) {
        ...
        let localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(modelOutputTrainingDetails, "ModelOutputTrainingDetails")
        };
        this.authentications.Bearer.applyToRequest(localVarRequestOptions);
        this.authentications.default.applyToRequest(localVarRequestOptions);
        if (Object.keys(localVarFormParams).length) {
    ...
    apiV1ModelByModelIdOutputByOutputIdGet(modelId, outputId) {
    ...
    apiV1ModelByModelIdOutputLatestGet(modelId) {
    ...
    apiV1ModelByModelIdTrainPost(modelId) {
    ...
    apiV1ModelCommonByLanguageByAnalyzerOutputLatestGet(language, analyzer) {
    ...
    apiV1ModelPost(modelCreateRequest) {
