...
let TaskCommands = class TaskCommands {
    ...
    build(target) {
        return __awaiter(this, void 0, void 0, function* () {
            this.serviceContainer.get(types_3.ITaskProvider).build(target);
        });
    }
    run(target) {
        return __awaiter(this, void 0, void 0, function* () {
            this.serviceContainer.get(types_3.ITaskProvider).run(target);
        });
    }
};
TaskCommands = __decorate([
