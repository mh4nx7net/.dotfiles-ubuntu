...
let ContextInitialization = class ContextInitialization {
    constructor(serviceContainer) {
        this.commandManager = serviceContainer.get(types_1.ICommandManager);
        this.platform = serviceContainer.get(types_2.IPlatformService);
    }
    initialize() {
...
ContextInitialization = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_3.IServiceContainer))
], ContextInitialization);
exports.ContextInitialization = ContextInitialization;
